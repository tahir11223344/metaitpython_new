      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-16 sm:py-20 grid lg:grid-cols-2 gap-12 ">
        ...
        >
          ...
          <p className="text-gray-300 text-sm sm:text-base leading-relaxed max-w-lg">
            Welcome to Meta IT Services blog page. These are information and
            creative insights that spark action. Read about expert perspectives
            on technology, digital marketing, news on the latest in AI, and
            inspiring company success stories. Move faster and stay ahead with
            more ambitious business intel.
          </p>
