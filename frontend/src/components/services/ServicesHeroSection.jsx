  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-16 sm:py-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <h1 className="text-[28px] sm:text-[35px] lg:text-[45px] font-bold text-white leading-tight mb-6">
            Marketing Campaigns <br />
            <span className="text-orange-500">Directed By Visionaries</span>
          </h1>
          <p className="text-gray-300 text-sm sm:text-base leading-relaxed max-w-lg">
            The algorithm is a vast jungle with constantly shifting terrain.
            Meta IT’s visionaries have the creative instinct to turn bold ideas
            into high-performing digital marketing packages that help you stay
            on top of the market food chain.
          </p>
